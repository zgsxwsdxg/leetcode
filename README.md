...
79 [Word Search](https://leetcode.com/problems/word-search/) dfs , ##one more
...
###97 [Interleaving String](https://leetcode.com/problems/interleaving-string/) no idea
...
105 [Construct Binary Tree from Preorder and Inorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) ok

106 [Construct Binary Tree from Inorder and Postorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/) ok

107 [Binary Tree Level Order Traversal II](https://leetcode.com/problems/binary-tree-level-order-traversal-ii/) ok
...
110 [Balanced Binary Tree](https://leetcode.com/problems/balanced-binary-tree/) recursion 
...
###140[Word Break II](https://leetcode.com/problems/word-break-ii/) no idea

141 [Linked List Cycle]( ) ok, easy

142 [Linked List Cycle II](https://leetcode.com/problems/linked-list-cycle-ii/) ok, good quesiton

###143[Reorder List ](https://leetcode.com/problems/reorder-list/) no idea
...
159 [Longest Substring with At Most Two Distinct Characters ](./lock/159_Longest_Substring_with_At_Most_Two_Distinct_Characters.md) lock, do it
...
167 [Two Sum II - Input array is sorted](./lock/167_Two_Sum_II.md) lock, easy
...
264 [Ugly Number II](https://leetcode.com/problems/ugly-number-ii/)  good quesiton
